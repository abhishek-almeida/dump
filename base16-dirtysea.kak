...
declare-option str base00 'rgb:e0e0e0' # very light gray
declare-option str base01 'rgb:d0dad0' # very light green
declare-option str base02 'rgb:d0d0d0' # light-gray
declare-option str base03 'rgb:707070' # gray
declare-option str base04 'rgb:202020' # black
declare-option str base05 'rgb:000000' # black
declare-option str base06 'rgb:f8f8f8' # white
declare-option str base07 'rgb:c4d9c4' # light green
declare-option str base08 'rgb:840000' # dark red
declare-option str base09 'rgb:006565' # dark cyan
declare-option str base0A 'rgb:755b00' # dark brown
declare-option str base0B 'rgb:730073' # dark magenta
declare-option str base0C 'rgb:755b00' # dark brown
declare-option str base0D 'rgb:007300' # dark green
declare-option str base0E 'rgb:000090' # dark blue
declare-option str base0F 'rgb:755b00' # dark brown
...
set-face global PrimarySelection "%opt{base0D},%opt{base07}"
set-face global SecondarySelection "%opt{base0D},%opt{base07}"
set-face global PrimaryCursor "%opt{base00},%opt{base05}"
set-face global SecondaryCursor "%opt{base00},%opt{base05}"
set-face global PrimaryCursorEol "%opt{base00},%opt{base05}"
...
set-face global MenuForeground "%opt{base06},%opt{base0D}+b"
set-face global MenuBackground "%opt{base0D},%opt{base07}"
set-face global MenuInfo "%opt{base0D},%opt{base07}"
set-face global Information "%opt{base0D},%opt{base07}"
